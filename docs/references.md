...
Lim, B., Arık, S.Ö., Loeff, N. and Pfister, T. (2021) 'Temporal fusion transformers for interpretable multi-horizon time series forecasting', *International Journal of Forecasting*, 37(4), pp. 1748–1764.
...
Zhou, H., Zhang, S., Peng, J., Zhang, S., Li, J., Xiong, H. and Zhang, W. (2021) 'Informer: beyond efficient transformer for long sequence time-series forecasting', *Proceedings of the AAAI Conference on Artificial Intelligence*, 35(12), pp. 11106–11115.

<!-- Additional inventory in References/ folder, available for future citation but not yet used in main-body prose: -->
<!-- - Haritha, S. and Judy, M.V. (2024) — distributed fuzzy cognitive maps + interpretability -->
<!-- - Islam, M.S. et al. (2023) — TFT applied to PV plant forecasting -->
<!-- - Rathnayaka, P. et al. (2022) — specialist vs generalist transformer for energy -->
<!-- - Shetty, S. et al. (2025) — ARIMA + SHAP for cryptocurrency -->
<!-- - Xue, X. et al. (2025) — transformer + SHAP for atmospheric water vapor -->
<!-- - Ye, X. et al. (2023) — temporal decomposition transformer for energy -->
